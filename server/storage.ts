...
export class MemStorage implements IStorage {
  ...
  private initializeData() {
    ...
    const engineTransmissionCategory = this.createCategory({
      ...
      image:
        "https://images.unsplash.com/photo-1682088646848-9422cc41e680",
    });
    ...
    const electricalElectronicsCategory = this.createCategory({
      ...
      image:
        "https://images.unsplash.com/photo-1546861199-4a5f8aaefd46",
    });
    ...
    const wheelsTiresCategory = this.createCategory({
      ...
      image:
        "https://images.unsplash.com/photo-1504809286473-606134ffa5bc",
    });
    ...
    const brakingSystemCategory = this.createCategory({
      ...
      image:
        "https://images.unsplash.com/photo-1623778066947-56f84020506d",
    });
    ...
    const lightingIndicatorsCategory = this.createCategory({
      ...
      image:
        "https://images.unsplash.com/photo-1597694526589-2437ff98e400",
    });
    ...
    const fuelAirSystemCategory = this.createCategory({
      ...
      image:
        "https://images.unsplash.com/photo-1583455585149-f380352de664",
    });
    ...
    const driveSystemCategory = this.createCategory({
      ...
      image:
        "https://images.unsplash.com/photo-1613521505063-f4c2726dd825",
    });
    ...
    const miscMaintenanceCategory = this.createCategory({
      ...
      image:
        "https://images.unsplash.com/photo-1538759619895-49daae839b70",
    });
    ...
    const suspensionSteeringCategory = this.createCategory({
      ...
      image:
        "https://images.unsplash.com/photo-1590335398114-31f5c445b42d",
    });
